...
This table lists the configuration variables required to operate Watson - Language Translator V3. These variables are specified when configuring a Watson Language Translator V3 asset in Splunk SOAR.
